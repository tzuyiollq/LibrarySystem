                ...
                case 2:
                    ...
                    do {
                        ...
                        switch (choice) {
                            ...
                            case 4:
                                borrowDAO.showUserBorrowRecords(user.getUserId());
                                break;
                            ...
                            case 5:
                                ...
                                sc.nextLine();
                                borrowDAO.showBookBorrowRecords(historyBookId);
                                break;

                            case 6:
                                reminderDAO.showDueSoonReminders(user.getUserId());
                                break;
                    ...
                    do {
                        ...
                        switch (adminChoice) {
                            ...
                            case 2:
                                ...
                                List<BorrowRecord> studentRecords = borrowDAO.getRecordsByStudentNo(searchStudentNo);
                            ...
                            case 4:
                                ...
                                boolean added = bookDAO.addBook(newBook, isbns);
                            ...
                            case 5:
                                ...
                                sc.nextLine();
                                boolean removed = bookDAO.removeBook(removeBookId);
                            ...
                            case 7:
                                ...
                                boolean suspended = userDAO.suspendUser(suspendNo);
                            ...
                            case 8:
                                ...
                                boolean activated = userDAO.activateUser(activateNo);
