...
public class BorrowRecordPanel extends JPanel {
    ...
    public BorrowRecordPanel(User user) {
        ...
        card.add(UIStyle.title("借閱紀錄"), BorderLayout.NORTH);

        String[] columns = {"紀錄ID", "書名", "借出日", "應還日", "歸還日", "天數"};
    ...
    private void loadData(User user) {
        ...
        List<BorrowRecord> records =
                service.getUserBorrowRecords(user.getUserId());
